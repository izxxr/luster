...
Luster is currently not a mature library and is undergoing heavy development. In this scenario,
...
When making major changes such, Make sure to discuss your change within our `Revolt Server <https://app.revolt.chat/invite/SfzyrsrA>`_.
Pull requests that implement a major change without any prior disussion will not be accepted.

Make sure to keep the scope of your pull request small and limited. Do not
make multiple changes in one pull request.
...
If you have got any questions, We highly suggest joining our official `Revolt Server <https://app.revolt.chat/invite/SfzyrsrA>`_.
Feel free to ask any questions or discuss your bug report, feature request or code change.
